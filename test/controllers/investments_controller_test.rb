...
class InvestmentsControllerTest < ActionController::TestCase
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post :create, investment: { category_id: @investment.category_id, name: @investment.name, portfolio_id: @investment.portfolio_id, user_id: @investment.user_id }
    end
  ...
  test "should update investment" do
    patch :update, id: @investment, investment: { category_id: @investment.category_id, name: @investment.name, portfolio_id: @investment.portfolio_id, user_id: @investment.user_id }
    assert_redirected_to investment_path(assigns(:investment))
  end
